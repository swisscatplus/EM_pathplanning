...
def main():
    ...
    if show_animation:  # pragma: no cover
        ...
        circle3 = plt.Circle((xs[0], ys[0]), 0.07, color='g', fill=False, linewidth=1)
        # ax.add_patch(circle1)
        # ax.add_patch(circle2)
        # ax.add_patch(circle3)
        # plot_arrow(robot_x, robot_y, robot_yaw)
        plot_arrow(start_x, start_y, start_yaw, length=0.05, width=0.02)
        plot_arrow(end_x, end_y, end_yaw, length=0.05, width=0.02)
